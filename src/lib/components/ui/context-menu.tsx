...
function ContextMenuSubTrigger({
  ...
  children,
  ...props
}: Omit<React.ComponentProps<typeof ContextMenuPrimitive.SubTrigger>, 'className'> & {
  inset?: boolean;
}) {
  return (
...
function ContextMenuSubContent({
  ...props
}: Omit<React.ComponentProps<typeof ContextMenuPrimitive.SubContent>, 'className'>) {
  return (
...
function ContextMenuContent({
  ...props
}: Omit<React.ComponentProps<typeof ContextMenuPrimitive.Content>, 'className'>) {
  return (
...
function ContextMenuLabel({
  inset,
  ...props
}: Omit<React.ComponentProps<typeof ContextMenuPrimitive.Label>, 'className'> & {
  inset?: boolean;
}) {
  return (
    <ContextMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn('text-foreground px-2 py-1.5 text-sm font-medium data-[inset]:pl-8')}
      {...props}
    />
  );
}
