...
const props = [
    { name: 'variant', type: "'default' | 'success' | 'warning' | 'destructive'", default: "'default'", description: 'Controls the color scheme and icon shown in the alert.' },
    { name: 'title', type: 'string', default: '—', description: 'Optional bold title rendered above the description.' },
    { name: 'children', type: 'ReactNode', default: '—', description: 'The alert description content.' },
];
...
<Alert variant="destructive" title="Error">Something went wrong.</Alert>`}
                >
                    <div className="space-y-3">
                        <Alert variant="default" title="Info">This is an informational message for the user.</Alert>
                        <Alert variant="success" title="Success">Your changes have been saved successfully!</Alert>
                        <Alert variant="warning" title="Warning">Please review your settings before continuing.</Alert>
                        <Alert variant="destructive" title="Error">An error occurred while processing your request.</Alert>
                    </div>
                </Example>
            </Section>

            <Section title="Without title" description="The title prop is optional — the alert works with description only.">
                <Example
                    title="No title"
