...
import * as ComponentDeps from "./navigation-menu";

// Extract the main component or first exported valid React component
const ComponentName = Object.keys(ComponentDeps).find(key => key !== 'default' && /^[A-Z]/.test(key)) || 'default';
const Component = ComponentName === 'default' ? ComponentDeps.default : ComponentDeps[ComponentName];
...
export default { title: "UI/Navigation Menu" };
