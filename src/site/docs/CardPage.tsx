...
const props = [
  {
    ...
    default: "'default'",
    description:
      'Visual style: default (no border), bordered (2px border), elevated (drop shadow).',
  },
  {
    name: 'children',
    type: 'ReactNode',
...
const subProps = [
  {
    ...
    type: '—',
    default: '—',
    description: 'Adds bottom margin. Wrap CardTitle and CardDescription inside.',
  },
  {
    name: 'CardTitle',
    type: '—',
    default: '—',
    description: 'Renders as an <h3>. The primary label of the card.',
  },
  {
    name: 'CardDescription',
    type: '—',
    default: '—',
    description: 'Renders as a <p> with muted color. Supporting text under the title.',
  },
  {
    name: 'CardContent',
    type: '—',
    default: '—',
    description: 'Container for the main body content of the card.',
  },
];
...
<Card variant="elevated">
  ...
  <CardContent><p>Drop shadow for depth.</p></CardContent>
      ...
      <Section
        title="Composition"
        description="Build rich cards using the provided sub-components."
      >
        <Example
